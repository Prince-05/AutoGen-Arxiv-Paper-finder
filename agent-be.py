...
summarizer_agent = AssistantAgent(
    ...
    model_client = 'openai_brain',
    system_message = (
        "You are an expert researcher. When you recive a JSON list of papers"
        "write a literature-riview style report in Markdown :\n" \
        "1. Start with a 2-3 introduction of the topic. \n" \
        "2. then include one bullet per paper with: title (as Markdown" \
        " link), authors, the specifc problem tackled and its key contribution. \n"
